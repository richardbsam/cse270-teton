...
class TestSmokeTest():
  ...
  def test_admin(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("Ilovebyui")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("latterdaysaint")
  ...
  def test_homePage(self):
    ...
    self.driver.set_window_size(1298, 784)
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Richard")
    self.driver.find_element(By.NAME, "lname").send_keys("Sam")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Sequence")
    self.driver.find_element(By.NAME, "bizname").send_keys("Sequence PetHub")
